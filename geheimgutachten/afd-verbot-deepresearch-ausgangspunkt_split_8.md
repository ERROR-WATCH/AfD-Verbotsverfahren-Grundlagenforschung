...
* juristische Entwürfe (z. B. **ENTWURF KLAGESCHR FT**, Mai 2025),
...
- --------------------------------------- ---------------------------------------------------- ----------------------------------------------- -------
1 **Illegale Finanzen** (Finance-Team) Forensic accounting / F U-SAR-Analyse 40-seitiger Report + `AfD_Finances_2013-24.csv` 30 Aug
2 **Paramilitär-Netz** (Security-Cluster) Geo-OS NT, Sat-Imagery, Interviews Interactive Active-Club-Map, Risiko-Score 25 Aug
...
--------------------------------------------------------------- ---------------------- -------------------------------------------------
**A Primär** VS-Geheimgutachten A/B, F U-SARs, AfD-Intern-Mails **nicht öffentlich** § 43 BVerfGG-Antrag → BMI/BMF; Sperrvermerk § 27a
...
* **Geo-Verification Loop**: Sat-Bild ↔ OS NT-Fotos ↔ Telegram-GPS-Tags (Active-Clubs).
...
------------------------------------- --------------------- -------------------------------------------------
**VS-Verweigerung** (Stufe VS-GEHE M) Verzögerung Verfahren § 27a-Schutzantrag + geschwärzte Surrogate
