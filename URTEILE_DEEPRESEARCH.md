...
1. **Björn Höcke (Landessprecher Thüringen):** 
   ...
   - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/01_Hoecke_SA_Parole_LG_Halle.txt) | BGH und Landgericht Halle Urteile.
...
2. **Marie-Thérèse Kaiser (Kreistagsabgeordnete Niedersachsen):**
   ...
   - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/02_Kaiser_Volksverhetzung_LG_Lueneburg.txt) | NDR, Correctiv.

3. **Florian Jäger (ehem. MdB, Bayern):**
   - **Partei-Status:** **DIREKT AfD** (Ehemaliger Bundestagsabgeordneter und Kreisvorsitzender).
   ...
   - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/03_Jaeger_Volksverhetzung_AG_Muenchen.txt) | Süddeutsche Zeitung, Correctiv.

4. **Bruno Fuchert (Kommunalpolitiker Bayern):**
   - **Partei-Status:** **DIREKT AfD** (Kommunalpolitiker und Kreisrat).
   - **Delikt:** Volksverhetzung (in neun Fällen).
   - **Urteil/Strafmaß:** Neun Monate Haft auf Bewährung (Februar 2026).
   - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/04_Fuchert_Volksverhetzung_LG_Traunstein.txt) | Regionale Presse Bayern.

5. **Holger Arppe (ehem. MdL Mecklenburg-Vorpommern):**
   - **Partei-Status:** **DIREKT AfD** (Ehemaliger Landtagsabgeordneter und Fraktionsvize).
   - **Delikt:** Volksverhetzung (volksverhetzende Kommentare im Internet).
   - **Urteil/Strafmaß:** Geldstrafe.
   - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/05_Arppe_Volksverhetzung_LG_Rostock.txt) | NDR, HPD.

6. **Kay Nerstheimer (ehem. MdA Berlin):**
   - **Partei-Status:** **DIREKT AfD** (Ehemaliger Abgeordneter im Berliner Abgeordnetenhaus).
   ...
   - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/06_Nerstheimer_Koerperverletzung_Volksverhetzung.txt) | Tagesspiegel.

7. **Zulässigkeit der Einstufung als „Faschist“ (Björn Höcke):**
   - **Partei-Status:** **DIREKT AfD** (Landessprecher Thüringen).
   - **Vorgang:** Eilantrag gegen die Bezeichnung als „Faschist“ gerichtlich zurückgewiesen.
   - **Urteil:** VG Meiningen (Az. 2 E 373/19) bestätigt, dass dies eine zulässige politische Meinungsäußerung auf nachweisbarer Tatsachengrundlage ist.
   - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/19_Hoecke_Faschist_VG_Meiningen.txt) | Verwaltungsgericht Meiningen.

8. **Zulässigkeit der Satirebezeichnung „Nazischlampe“ (Alice Weidel):**
   - **Partei-Status:** **DIREKT AfD** (Fraktionsvorsitzende und Co-Bundesvorsitzende).
   - **Vorgang:** Unterlassungsklage gegen extra-3-Bezeichnung abgewiesen.
   - **Urteil:** LG Hamburg (Az. 324 O 217/17) bewertet den Ausdruck als zulässige Satire im politischen Meinungskampf.
   - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/20_Weidel_Nazischlampe_LG_Hamburg.txt) | Landgericht Hamburg.

9. **Carsten Härle (Kommunalpolitiker Hessen):**
   - **Partei-Status:** **DIREKT AfD** (Lokalpolitiker und Fraktionsvorsitzender in Heusenstamm).
   - **Delikt:** Volksverhetzung (Dehumanisierung von Migranten im Internet).
   - **Urteil:** Rechtskräftige Geldstrafe durch das AG Offenbach.
   - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/38_Carsten_Haerle_Volksverhetzung_AG_Offenbach.txt) | AG Offenbach.

10. **Beatrix von Storch (MdB):**
    - **Partei-Status:** **DIREKT AfD** (Bundestagsabgeordnete und ehem. stellv. Bundessprecherin).
    - **Delikt:** Volksverhetzung (Ermittlungsverfahren wegen rassistischer Herabwürdigung von Muslimen/Arabern).
...
11. **Christina Baum (MdB Baden-Württemberg):**
    - **Partei-Status:** **DIREKT AfD** (Bundestagsabgeordnete und Mitglied des Bundesvorstands).
...
12. **Jörg Sobolewski (ehem. JA-Bundesvorstand):**
    - **Partei-Status:** **DIREKT AfD** (Ehemaliger stellvertretender Bundesvorsitzender der Jungen Alternative [JA] und AfD-Funktionär).
    - **Delikt:** Verwenden von Kennzeichen verfassungswidriger Organisationen (§ 86a StGB) durch Zeigen der verbotenen SA-Geste.
    - **Urteil:** Geldstrafe.
    - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/56_Joerg_Sobolewski_SA_Geste_AG_Tiergarten.txt) | AG Tiergarten.

13. **Sven W. (ehem. Kreisvorstand Thüringen):**
    - **Partei-Status:** **DIREKT AfD** (Ehemaliges Vorstandsmitglied im Kreisverband Weimarer Land).
    - **Delikt:** Besitz von Kinderpornografie (§ 184b StGB).
    - **Urteil:** Freiheitsstrafe auf Bewährung durch das AG Weimar.
    - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/58_Sven_W_Kinderpornografie_AG_Weimar.txt) | AG Weimar.

14. **Sven Liebich (Rechtsextremer Agitator):**
    - **Partei-Status:** **INDIREKT AfD** (Kein formales Parteibuch, aber engster Kooperationspartner, offizieller Redner auf AfD-Kundgebungen und Betreiber von AfD-nahen Propagandaplattformen im Vorfeld).
    - **Delikt:** Systematische Volksverhetzung, Beleidigung und Verleumdung im Netz.
    - **Urteil:** Freiheitsstrafe von einem Jahr und sechs Monaten ohne Bewährung (Haftstrafe).
    - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/52_Sven_Liebich_Volksverhetzung_Haft_LG_Halle.txt) | LG Halle.

15. **Thomas Suchka (Kommunalpolitiker Bayern):**
    - **Partei-Status:** **DIREKT AfD** (AfD-Kreisrat in Ebersberg, Bayern).
    - **Delikt:** Volksverhetzung (Rassistische Asyl-Hetze auf Facebook).
    - **Urteil:** Geldstrafe.
    - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/54_Thomas_Suchka_Volksverhetzung_AG_Ebersberg.txt) | AG Ebersberg.

---

### Körperverletzung & Gewaltdelikte

16. **Felix Alexander Cassel (Vorsitzender Junge Alternative NRW):**
    - **Partei-Status:** **DIREKT AfD** (Vorsitzender der Jungen Alternative [JA] Essen / NRW).
...
17. **Kai Borrmann (Bezirksverordneter Berlin):**
    - **Partei-Status:** DIREKT AfD (Bezirksverordneter in Berlin-Mitte).
...
18. **Stefan Räpple (ehem. MdL Baden-Württemberg):**
    - **Partei-Status:** DIREKT AfD (Ehemaliger Abgeordneter im Landtag von Baden-Württemberg).
...
19. **Sebastian Münzenmeier (MdB, Rheinland-Pfalz):**
    - **Partei-Status:** DIREKT AfD (Mitglied des Deutschen Bundestags und ehem. Landesvorsitzender RLP).
...
20. **Dubravko Mandic (Kommunalpolitiker, Baden-Württemberg):**
    - **Partei-Status:** DIREKT AfD (Ehemaliger Stadtrat und Kreisvorstandsmitglied in Freiburg).
...
21. **Andreas Kalbitz (ehem. Landesvorsitzender Brandenburg):**
    - **Partei-Status:** DIREKT AfD (Ehemaliger Landesvorsitzender und Bundesvorstandsmitglied).
...
22. **Sven Ebert (Kreistagsabgeordneter Sachsen-Anhalt):**
    - **Partei-Status:** DIREKT AfD (Mitglied des Kreistags Bitterfeld).
...
23. **Stefan Hrdy (Kommunalpolitiker Hessen):**
    - **Partei-Status:** DIREKT AfD (Kommunalpolitiker und Fraktionsvorsitzender im Hochtaunuskreis).
...
24. **Maik G. (Kommunalpolitiker Baden-Württemberg):**
    - **Partei-Status:** DIREKT AfD (Stadtverbandsvorstandsmitglied in Sinsheim).
    - **Delikt:** Vorsätzliche Körperverletzung (Tätlicher Angriff im Wahlkampf).
    - **Urteil:** Rechtskräftige Geldstrafe.
    - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/53_Maik_G_Koerperverletzung_AG_Sinsheim.txt) | AG Sinsheim.

25. **Robert T. (JA-Aktivist):**
    - **Partei-Status:** **INDIREKT AfD** (Aktivist der JA Leipzig, Schläger im militanten AfD-Vorfeld, kein formales Mandat).
    - **Delikt:** Schwere Körperverletzung (§ 226 StGB) durch brutale Schädel- und Gesichtsverletzung eines Demonstranten.
    - **Urteil:** Freiheitsstrafe von zwei Jahren und zwei Monaten ohne Bewährung (Haftstrafe).
    - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/55_Robert_T_JA_Aktivist_Gewalt_LG_Leipzig.txt) | LG Leipzig.

---

### Amtsmissbrauch & Dienstvergehen

26. **Thorsten Czuppon (MdL Thüringen):**
    - **Partei-Status:** DIREKT AfD (Polizeibeamter und Thüringer Landtagsabgeordneter).
...
27. **Richard Graupner (MdL Bayern):**
...
28. **Kay-Uwe Ziegler (MdB):**
    - **Partei-Status:** DIREKT AfD (Mitglied des Deutschen Bundestags).
...
29. **Frauke Petry (ehem. AfD-Bundesvorsitzende):**
    - **Partei-Status:** DIREKT AfD (Ehemalige Bundes-AfD-Vorsitzende und Fraktionschefin).
...
30. **Daniel Halemba (MdL Bayern):**
    - **Partei-Status:** DIREKT AfD (Abgeordneter im bayerischen Landtag).
...
31. **Wiebke Muhsal (MdL Thüringen):**
    - **Partei-Status:** DIREKT AfD (Abgeordnete im Thüringer Landtag).
...
32. **Jan-Ulrich Weiß (MdL Brandenburg):**
    - **Partei-Status:** DIREKT AfD (Ehemaliger Abgeordneter im Landtag Brandenburg).
...
33. **Rolf Dipp (ehem. AfD-Stadtrat Salzgitter):**
    - **Partei-Status:** DIREKT AfD (Ehemaliger AfD-Stadtratsabgeordneter).
...
34. **Stefan Beck (ehem. Landesschatzmeister RLP):**
    - **Partei-Status:** DIREKT AfD (Ehemaliger oberster Landesschatzmeister der AfD RLP).
    - **Delikt:** Untreue (systematische Selbstbedienung und Veruntreuung von Parteigeldern).
    - **Urteil:** Freiheitsstrafe auf Bewährung.
    - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/60_Stefan_Beck_Untreue_LG_Mainz.txt) | LG Mainz.

---

### Waffenbesitz & Sonstige Delikte

35. **Philip Steinbeck (Kommunalpolitiker Mecklenburg-Vorpommern):**
    - **Partei-Status:** DIREKT AfD (Gemeindevertreter und Kommunalpolitiker).
...
36. **Stephan Brandner (MdB, Thüringen):**
    - **Partei-Status:** DIREKT AfD (Mitglied des Deutschen Bundestags und Justiziar der Bundes-AfD).
...
37. **Matthias Moosdorf (MdB, Sachsen):**
    - **Partei-Status:** DIREKT AfD (Abgeordneter im Deutschen Bundestag).
...
38. **Thomas Seitz (ehem. Staatsanwalt und MdB):**
    - **Partei-Status:** DIREKT AfD (Ehemaliger Staatsanwalt und MdB).
...
39. **Jessica Bießmann (ehem. MdA Berlin):**
    - **Partei-Status:** **INDIREKT AfD** (Ehemaliges Mitglied des Berliner Abgeordnetenhauses, disziplinarischer Parteiausschluss wegen NS-Posing vor Hitlerweinflaschen).
    - **Urteil:** Schiedsgerichtlich bestätigter Parteiausschluss.
...
40. **Heinrich Fiechtner (ehem. MdL Baden-Württemberg):**
    - **Partei-Status:** DIREKT AfD (Ehemaliger Landtagsabgeordneter).
...
41. **Jens Maier (Richter und ehem. MdB, Sachsen):**
    - **Partei-Status:** DIREKT AfD (Ehemaliger Richter und MdB Sachsen).
...
42. **Alice Weidel (Co-Vorsitzende - „E-Mail-Affäre“):**
    - **Partei-Status:** DIREKT AfD (Co-Bundesvorsitzende der AfD und Fraktionsvorsitzende im Bundestag).
...
43. **Udo Stein (MdL Thüringen):**
    - **Partei-Status:** DIREKT AfD (Abgeordneter im thüringischen Landtag).
...
44. **Siegbert Droese (ehem. MdB Sachsen):**
    - **Partei-Status:** DIREKT AfD (Ehemaliger Abgeordneter im Deutschen Bundestag).
...
45. **Doris von Sayn-Wittgenstein (ehem. Landeschefin Schleswig-Holstein):**
...
46. **Heiko Hecht (ehem. Kreisvorstand):**
    - **Partei-Status:** DIREKT AfD (Lokalpolitiker und Vorstandsmitglied in Berlin-Mitte).
    - **Delikt:** Nötigung, Stalking und Beleidigung.
    - **Urteil:** Rechtskräftige Geldstrafe.
    - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/59_Heiko_Hecht_Noetigung_AG_Tiergarten.txt) | AG Tiergarten.

---

### Spionage, Landesverrat & Hochverrat

47. **Jian G. (persönlicher Büromitarbeiter von Maximilian Krah, MdB/MdEP):**
...
48. **Maximilian Krah (Mitglied des AfD-Bundesvorstands, MdB/MdEP):**
...
49. **Gunnar Lindemann (MdA Berlin):**
...
50. **Birgit Malsack-Winkemann (ehem. Richterin & MdB):**
    - **Partei-Status:** **DIREKT AfD** (Ehemalige Bundestagsabgeordnete und Mitglied des Bundesschiedsgerichts).
...
51. **Maximilian T. (ehem. AfD-Mitarbeiter im Bundestag):**
...
52. **Kurt H. (Kommunalpolitiker Grimma):**
    ...
    - **Quelle/Beleg:** [Volltext-Beleg im Repository](./dokumente/hauptquellen/urteilsbelege/49_Kurt_H_Saechsische_Separatisten_Terror_GBA.txt) | Generalbundesanwalt (GBA).

---

## 2. Urteile und gerichtliche Beschlüsse gegen die Gesamtpartei und Landesverbände

53. **Bundesamt für Verfassungsschutz vs. AfD (Gesamtpartei):**
...
54. **Entzug von Waffenbesitzkarten (Verwaltungsgerichte bundesweit):**
...
55. **Verweigerung des Beamtenstatus (OVG Weimar, VG Berlin):**
...
56. **Ausschluss von Parlamentsrechten (Bundesverfassungsgericht):**
...
57. **Strafzahlungen wegen illegaler Parteispenden (BVerwG):**
