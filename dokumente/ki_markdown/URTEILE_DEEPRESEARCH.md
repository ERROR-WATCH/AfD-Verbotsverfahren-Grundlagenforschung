...
> * 📝 [**Gesamt-Urteilsregister als konsolidierter TXT-Volltext**](../hauptquellen/AfD_Gerichtsentscheidungen_Urteilsregister_Volltext.md)
...
1. **Björn Höcke:** 
   ...
   - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/01_Hoecke_SA_Parole_LG_Halle.md)
...
2. **Marie-Thérèse Kaiser:**
   ...
   - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/02_Kaiser_Volksverhetzung_LG_Lueneburg.md)

3. **Florian Jäger:**
   - **Partei-Status:** 🔴 **DIREKT AfD** (Ehemaliger MdB).
   - **Urteil:** Geldstrafe wegen Volksverhetzung.
   - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/03_Jaeger_Volksverhetzung_AG_Muenchen.txt)

4. **Bruno Fuchert:**
   - **Partei-Status:** 🔴 **DIREKT AfD** (Kreisrat).
   - **Urteil:** 9 Monate Haft auf Bewährung wegen Volksverhetzung.
   - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/04_Fuchert_Volksverhetzung_LG_Traunstein.txt)

5. **Holger Arppe:**
   - **Partei-Status:** 🔴 **DIREKT AfD** (Ehemaliger MdL).
   - **Urteil:** Geldstrafe wegen Volksverhetzung.
   - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/05_Arppe_Volksverhetzung_LG_Rostock.txt)

6. **Kay Nerstheimer:**
   - **Partei-Status:** 🔴 **DIREKT AfD** (Ehemaliger MdA Berlin).
   - **Urteil:** Geldstrafe wegen Volksverhetzung.
   - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/06_Nerstheimer_Koerperverletzung_Volksverhetzung.txt)
...
7. **Björn Höcke (Gerichtsbeschluss „Faschist“):**
   ...
   - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/19_Hoecke_Faschist_VG_Meiningen.md)
...
8. **Alice Weidel (Gerichtsbeschluss):**
   ...
   - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/20_Weidel_Nazischlampe_LG_Hamburg.md)

9. **Carsten Härle:**
   - **Partei-Status:** 🔴 **DIREKT AfD** (Fraktionsvorsitzender im Kommunalparlament).
   - **Urteil:** Geldstrafe wegen Volksverhetzung.
   - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/38_Carsten_Haerle_Volksverhetzung_AG_Offenbach.txt)

10. **Beatrix von Storch:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (MdB).
    - **Status:** Strafverfahren wegen Volksverhetzung (Immunität aufgehoben).
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/41_Beatrix_von_Storch_Volksverhetzung_Ermittlung.md)

11. **Christina Baum:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (MdB und Bundesvorstand).
    - **Urteil:** Geldstrafe wegen Beleidigung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/45_Christina_Baum_Beleidigung.txt)

12. **Jörg Sobolewski:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Ehem. stellv. Bundesvorsitzender der JA).
    - **Urteil:** Geldstrafe wegen SA-Geste.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/56_Joerg_Sobolewski_SA_Geste_AG_Tiergarten.md)
...
13. **Sven Liebich:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/52_Sven_Liebich_Volksverhetzung_Haft_LG_Halle.md)

14. **Thomas Suchka:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Kreisrat in Bayern).
    - **Urteil:** Geldstrafe wegen Volksverhetzung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/54_Thomas_Suchka_Volksverhetzung_AG_Ebersberg.txt)

15. **André Poggenburg:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Ehem. Landesvorsitzender Sachsen-Anhalt).
    - **Urteil:** Geldstrafe wegen Volksverhetzung („Kümmelhändler“).
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/50_Andre_Poggenburg_Kuemmelhaendler_AG_Halle.md)

16. **Uwe Junge:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Ehem. Landesvorsitzender RLP).
    - **Urteil:** Geldstrafe wegen homophober Beleidigung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/51_Uwe_Junge_Beleidigung_AG_Mainz.md)
...
17. **Gerd Sch.:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/64_Gerd_Sch_Volksverhetzung_AG_Cottbus.md)
...
18. **Halger H.:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/71_Halger_H_Hitlergruss_AG_Chemnitz.md)
...
19. **Stefan W.:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/76_Stefan_W_Volksverhetzung_AG_Gera.md)
...
20. **Daniel R.:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/80_Daniel_R_Hakenkreuz_Volksverhetzung_AG_Bautzen.md)
...
21. **Felix Alexander Cassel:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/07_Cassel_Gewalttat_AG_Essen.txt)

22. **Kai Borrmann:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Bezirksverordneter Berlin).
    - **Urteil:** Geldstrafe wegen Körperverletzung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/08_Borrmann_Koerperverletzung_LG_Berlin.txt)

23. **Stefan Räpple:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Ehemaliger MdL).
    - **Urteil:** Verurteilt wegen Widerstands gegen Polizisten.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/09_Raepple_Gewaltdelikt_LG_Karlsruhe.txt)

24. **Sebastian Münzenmeier:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (MdB).
    - **Urteil:** Beihilfe zur gefährlichen Körperverletzung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/10_Muenzenmeier_Hooligan_Gewalt_LG_Mainz.txt)

25. **Dubravko Mandic:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Ehemaliger Stadtrat).
    - **Urteil:** Gefährliche Körperverletzung (Reizgas).
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/11_Mandic_Gewalt_AG_Freiburg.txt)
...
26. **Andreas Kalbitz:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/12_Kalbitz_Koerperverletzung_AG_Potsdam.txt)

27. **Sven Ebert:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Kreistagsabgeordneter).
    - **Urteil:** Gefährliche Körperverletzung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/33_Sven_Ebert_Koerperverletzung_LG_Magdeburg.txt)

28. **Stefan Hrdy:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Fraktionsvorsitzender Hochtaunuskreis).
    - **Urteil:** Körperverletzung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/39_Stefan_Hrdy_Koerperverletzung_AG_Wiesbaden.txt)

29. **Maik G.:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Stadtverbandsvorstand Sinsheim).
    - **Urteil:** Vorsätzliche Körperverletzung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/53_Maik_G_Koerperverletzung_AG_Sinsheim.txt)
...
30. **Robert T.:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/55_Robert_T_JA_Aktivist_Gewalt_LG_Leipzig.md)
...
31. **Alexander M.:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/66_Alexander_M_Koerperverletzung_AG_Erfurt.txt)
...
32. **Heiko H.:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/73_Heiko_H_Koerperverletzung_AG_Zeitz.txt)
...
33. **Stefan K.:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/79_Stefan_K_JA_Gewalttat_AG_Dresden.md)
...
34. **Thorsten Czuppon:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/29_Thorsten_Czuppon_Falschanzeige_LG_Erfurt.md)
...
35. **Richard Graupner:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/34_Richard_Graupner_Dienstgeheimnis_LG_Bamberg.txt)
...
36. **Kay-Uwe Ziegler:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/13_Ziegler_Betrug_AG_Dessau.txt)

37. **Frauke Petry:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Ehemalige Bundesvorsitzende).
    - **Urteil:** Subventionsbetrug, Untreue, Steuerhinterziehung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/14_Petry_Betrug_LG_Leipzig.txt)

38. **Daniel Halemba:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (MdL).
    - **Urteil:** Geldwäsche, Nötigung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/15_Halemba_Geldwaesche_LG_Wuerzburg.txt)

39. **Wiebke Muhsal:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (MdL).
    - **Urteil:** Betrug.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/30_Wiebke_Muhsal_Betrug_LG_Erfurt.md)

40. **Jan-Ulrich Weiß:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Ehemaliger MdL).
    - **Urteil:** Haft auf Bewährung wegen Zigarettenschmuggels.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/31_Jan_Ulrich_Weiss_Schmuggel_LG_Potsdam.txt)

41. **Rolf Dipp:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Ehem. Stadtrat).
    - **Urteil:** Haft auf Bewährung wegen Erpressung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/32_Rolf_Dipp_Erpressung_LG_Braunschweig.md)

42. **Stefan Beck:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Ehem. Landesschatzmeister RLP).
    - **Urteil:** Veruntreuung von Parteigeldern.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/60_Stefan_Beck_Untreue_LG_Mainz.md)
...
43. **Jörg Meuthen:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/62_Joerg_Meuthen_Spendenaffaere_BVerwG.md)
...
44. **Guido Reil:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/63_Guido_Reil_Spendenaffaere_BVerwG.md)
...
45. **Daniela W.:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/65_Daniela_W_Versicherungsbetrug_AG_Dresden.md)

46. **Stefan Räpple (Corona):**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Ehemaliger MdL).
    - **Urteil:** Geldstrafe wegen unberechtigter Erlangung von Corona-Subventionen (AG Offenburg).
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/72_Stefan_Raepple_Corona_Subventionsbetrug_AG_Offenburg.md)

47. **Michael Musto:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Gemeinderat der AfD Backnang).
    - **Urteil:** Geldstrafe wegen Briefwahlfälschung bei der Kommunalwahl.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/77_Michael_Musto_Wahlfaelschung_AG_Backnang.md)
...
48. **Philip Steinbeck:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/16_Steinbeck_Waffen_LG_Schwerin.txt)

49. **Stephan Brandner:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (MdB).
    - **Urteil:** Strafbefehl wegen Beleidigung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/17_Brandner_Beleidigung_AG_Gera.txt)

50. **Matthias Moosdorf:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (MdB).
    - **Status:** Verfahren wegen Hitlergruß im Bundestag.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/18_Moosdorf_Hitlergruss_BT.txt)

51. **Thomas Seitz:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (MdB).
    - **Urteil:** Entlassung aus dem Staatsdienst wegen Rechtsextremismus.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/26_Seitz_Richteramt_Entlassung_DGH_Karlsruhe.md)
...
52. **Jessica Bießmann:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/37_Jessica_Biessmann_Hitlerwein_AG_Tiergarten.txt)

53. **Heinrich Fiechtner:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Ehemaliger MdL).
    - **Urteil:** Geldstrafe wegen Polizistenbeleidigung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/40_Heinrich_Fiechtner_Beleidigung_AG_Stuttgart.txt)

54. **Jens Maier:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Ehemaliger MdB).
    - **Urteil:** Zwangspensionierung aus Richteramt durch BGH.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/35_Jens_Maier_Richter_Ruhestand_DG_Leipzig.md)

55. **Alice Weidel:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Co-Bundesvorsitzende).
    - **Status:** Ermittlungen zur "E-Mail-Affäre" (Marionetten-Brief).
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/42_Alice_Weidel_Email_Affaere_Metadaten.md)

56. **Udo Stein:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (MdL).
    - **Urteil:** Zwangeinweisung & Waffenentzug nach Amokdrohung.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/43_Udo_Stein_Waffengesetz_Landtag.md)

57. **Siegbert Droese:**
    - **Partei-Status:** 🔴 **DIREKT AfD** (Ehemaliger MdB).
    - **Status:** Ermittlungen wegen Wolfsschanze-NS-Pose.
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/44_Siegbert_Droese_NS_Provokation.md)
...
58. **Doris von Sayn-Wittgenstein:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/46_Doris_Sayn_Wittgenstein_Rechtsextremismus_Ausschluss.txt)
...
59. **Heiko Hecht:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/59_Heiko_Hecht_Noetigung_AG_Tiergarten.txt)
...
60. **Lars S.:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/78_Lars_S_Noetigung_Unfallflucht_LG_Potsdam.md)
...
61. **Jian G.:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/27_Jian_G_Spionage_Krah_OLG_Dresden.md)
...
62. **Maximilian Krah:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/28_Maximilian_Krah_Ermittlungsverfahren_GBA.md)
...
63. **Gunnar Lindemann:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/47_Gunnar_Lindemann_Finanzen_Donbas.txt)
...
64. **Birgit Malsack-Winkemann:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/36_Birgit_Malsack_Winkemann_Reichsbuerger_BGH.md)
...
65. **Maximilian T.:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/48_Maximilian_T_Terrorverdacht_Franco_A.md)
...
66. **Kurt H.:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/49_Kurt_H_Saechsische_Separatisten_Terror_GBA.md)
...
67. **Tobias Laue:**
    ...
    - **Quelle:** [Lokaler Beleg](../hauptquellen/urteilsbelege/61_Tobias_Laue_Bandidos_Bundestag.md)
...
69. **Petr Bystron:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/70_Petr_Bystron_Bestechung_Razzia_GBA.md)
...
70. **Jörg S.:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/74_Joerg_S_Mitarbeiter_Hilse_Widerstand_AG_Tiergarten.md)
...
71. **Uwe L.:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/75_Uwe_L_Reichsbuerger_Terror_GBA.md)
...
72. **Sven W.:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/58_Sven_W_Kinderpornografie_AG_Weimar.md)
...
73. **René P.:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/67_Rene_P_Kinderpornografie_Ermittlung.md)
...
74. **Ehem. AfD-Ratsherr Hannover:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/68_AfD_Ratsherr_Hannover_Kinderpornografie_Ermittlung.md)
...
75. **Philip W.:**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/69_Philip_W_Vergewaltigung_Augsburg.md)
...
76. **Bundesamt für Verfassungsschutz vs. AfD (Gesamtpartei):**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/22_BfV_vs_AfD_Verdachtsfall_OVG_Muenster.md)
...
77. **Entzug von Waffenbesitzkarten (Verwaltungsgerichte bundesweit):**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/23_Waffenbesitzkarten_Entzug_VG_Duesseldorf.md)
...
78. **Verweigerung des Beamtenstatus (OVG Weimar, VG Berlin):**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/24_Beamtenstatus_Ausschluss_OVG_Weimar.txt)
...
79. **Ausschluss von Parlamentsrechten (Bundesverfassungsgericht):**
    ...
    - **Quelle/Beleg:** [Lokaler Beleg](../hauptquellen/urteilsbelege/25_Bundestag_Ausschussvorsitz_BVerfG.md)
